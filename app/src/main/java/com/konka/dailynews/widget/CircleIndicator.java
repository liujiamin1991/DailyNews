...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener
{
    ...
    public void setViewPager(int childCount, ViewPager viewPager)
    {
        this.childCount = childCount;
        mViewpager = viewPager;
        mCurrentPosition = mViewpager.getCurrentItem();
        createIndicators(childCount,viewPager);
    ...
    private void createIndicators(int childCount, ViewPager viewPager)
    {
